        ...
        <div class="col-md-9 blog-header">
            <div class=" blog-head">
                <div class="col-md-4 blog-top">
                    <div class="blog-in">
                        <a href="single.html"><img class="img-responsive" src="{{('theme/images/bl.jpg')}}" alt=" "></a>
                        <div class="blog-grid">
                ...
                <div class="col-md-4 blog-top">
                    <div class="blog-in">
                        <a href="single.html"><img class="img-responsive" src="theme/images/bl1.jpg" alt=" "></a>
                        <div class="blog-grid">
                            <h3><a href="single.html">On the other hand</a></h3>
                            <div class="date">
                                <span class="date-in"><i class="glyphicon glyphicon-calendar"> </i>22.08.2014</span>
                ...
                <div class="col-md-4 blog-top">
                    <div class="blog-in">
                        <a href="single.html"><img class="img-responsive" src="theme/images/bl2.jpg" alt=" "></a>
                        <div class="blog-grid">
                            <h3><a href="single.html">On the other hand</a></h3>
                            <div class="date">
                                <span class="date-in"><i class="glyphicon glyphicon-calendar"> </i>22.08.2014</span>
            ...
            <div class=" blog-head">
                <div class="col-md-4 blog-top">
                    <div class="blog-in">
                        <a href="single.html"><img class="img-responsive" src="theme/images/bl3.jpg" alt=" "></a>
                        <div class="blog-grid">
                            <h3><a href="single.html">On the other hand</a></h3>
                            <div class="date">
                                <span class="date-in"><i class="glyphicon glyphicon-calendar"> </i>22.08.2014</span>
                ...
                <div class="col-md-4 blog-top">
                    <div class="blog-in">
                        <a href="single.html"><img class="img-responsive" src="theme/images/bl4.jpg" alt=" "></a>
                        <div class="blog-grid">
                            <h3><a href="single.html">On the other hand</a></h3>
                            <div class="date">
                                <span class="date-in"><i class="glyphicon glyphicon-calendar"> </i>22.08.2014</span>
                ...
                <div class="col-md-4 blog-top">
                    <div class="blog-in">
                        <a href="single.html"><img class="img-responsive" src="theme/images/bl5.jpg" alt=" "></a>
                        <div class="blog-grid">
                            <h3><a href="single.html">On the other hand</a></h3>
                            <div class="date">
                                <span class="date-in"><i class="glyphicon glyphicon-calendar"> </i>22.08.2014</span>
